...
Catalog Status:
  ...
  In Progress: Collinder (VII/92) — brief issued, ready to execute
Database State:
  SURFACE: 76,314
  RAW: ~84,790
  HOLDING: ~84,979
Recent Completed Actions:
  ...
  • Canonical objects table schema locked (Part XXXIII)
  • Normalization repair complete — 80,637 id_normalized values rebuilt
  • Canonical normalization rule locked: regexp_replace(lower(translate(id_key,'+-','pm')),'[^a-z0-9:]','','g')
  • Alias collision repair complete — 26 exceptions flagged, registry in Part XXXIV
  • Zero identity collisions confirmed
  • Normalization Canon locked (Part XXXIV)
  • Aliases table FK gap documented as V1.1 structural debt
Validated Canon Decisions:
  • JSONB prohibited permanently — Section 104
  • Colon preserved as namespace separator in normalization
  • +-  signs translated to pm before stripping — galactic coordinate preservation
  • primary_id and legacy_primary_id are sacred — never normalized
  • Coordinate hash suffix for irresolvable source string ambiguity
Next Authorized Action: Execute Collinder ingestion (VII/92) — brief already issued
Do NOT Perform:
...
Known Risks or Audits Pending:
  • 26 alias normalization exceptions pending manual resolution (Part XXXIV Section 111)
  • Aliases table FK gap — V1.1 structural debt (Part XXXIV Section 112)
...
## 112. Aliases Table Structural Debt (Known Risk)
