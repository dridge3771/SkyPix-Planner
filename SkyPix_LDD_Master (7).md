...
## Master Composite
**Created:** 2026-02-17
**Last Revised:** 2026-02-23 (Part XXXII)
...
4. Gum Catalog (VIII/36) — Structure/LES — **LAST in Wave 3**

**Gum sequencing rationale:** Gum associations depend on a rich SURFACE population. Wave 2 (SNR/PN) and Wave 3 (OC/GC) both contribute objects embedded in Gum regions. Running Gum before these waves produces incomplete associations requiring re-run after each subsequent wave. Gum ingestion and association pass executes after Collinder/Melotte/Harris are complete and packed.
...
1. Complete Wave 2 ingestion (Abell PN → PK complete → Green SNR)
2. Write Payload Packing Contract v1.0 — design precedes implementation
3. Execute pilot packing wave (EN/SNR/GC subset)
4. Wave 3 ingestion (Collinder → Melotte → Harris GC → Gum last)
5. Spectral enrichment pass — L1 automated, L2 from catalog sources
6. UI/SUD/Planner development (Chatty full focus post-Wave 3)
7. Beta — 20 Masters of PixInsight users, April 2026
