...
Project Phase: [ Ingestion | Enrichment | Packing | Planner ]
Active Wave: [ Wave # ]
Catalog Status:
  Completed: [ catalog list ]
  In Progress: [ catalog if any ]
Database State:
  SURFACE: #####
  RAW: #####
  HOLDING: #####
...
Validated Canon Decisions:
  • ...
  • ...
Next Authorized Action: [ single executable step ]
Do NOT Perform:
  • ...
  • ...
Packing Status: NOT ACTIVE / ACTIVE
