BOOT DIRECTIVE:
This document is the SkyPix Living Design Document (LDD).
...
### SKYPIX SYSTEM BOOT PROTOCOL

This document is the authoritative operating specification for SkyPix.

Any AI assistant or collaborator MUST:

1. Read this document completely before proposing actions.
2. Treat the LDD as the single source of truth.
3. Follow all Canon rules and Prime Directives.
4. Never redesign architecture without explicit authorization.
5. Respect mandatory workflow separation:
   **INGESTION ≠ ENRICHMENT ≠ PACKING ≠ PROMOTION**
6. SkyPix is an Astrophotography Materialization Engine.
7. RAW stores facts. SURFACE stores decisions.
8. Packing produces information. The user produces strategy.

After loading this document, respond only:
**"SkyPix Boot Complete. Awaiting Directive."**
